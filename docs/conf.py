...
.. _Nova compute flavor: /cloud/openstack/v1//support/openstack_big-ip_flavors.html
.. _F5 OpenStack Heat template deployment instructions: /cloud/openstack/heat/latest/deploy-heat-templates.html
.. _F5 OpenStack Heat Plugins: /products/openstack/heat-plugins/kilo/install-f5-heat-plugins.html
